...
const Auth = () => {
  ...
  const TEST_EMAIL = 'teste@cafemanha.com';
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen bg-gradient-warm pt-[15px] flex items-center justify-center px-4 py-12">
          ...
          <div className="bg-card rounded-2xl shadow-lg p-8">
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login">
                ...
                <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-900 rounded-lg p-3 mb-4">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300">
                    <strong>Email:</strong> teste@cafemanha.com
                  </p>
                  <p className="text-xs text-blue-700 dark:text-blue-300">
              ...
              <TabsContent value="register">
                <div className="text-center mb-6">
                  <p className="text-muted-foreground">Crie sua conta e comece a presentear!</p>
                </div>
